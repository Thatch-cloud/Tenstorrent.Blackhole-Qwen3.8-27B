...
| E4 fusion/pipeline | Norm batching passed layer, full-model, retained replay, selection34054076401 and matched requests34055684657. Grouped attention passed micro34061073573 and real-weight layer34061952468; T32 layer1.975->1.600ms at4K,3.073->2.014ms at16K | Static full-model grouped-attention gate prepared; preserve T1/2/4. Dynamic-position replay still requires certification; component cost is not committed tok/s |
