...
| E4 fusion/pipeline | Direct layout DMA full-model34064443450 exact: matched T32 verification106.98->102.99ms at4K,109.94->105.94ms at16K. Parallel groups micro34065899606 exact:0.854->0.640ms and1.269->1.026ms, up to96 SDPA workers | Prepared parallel reader simulator and real-layer gates next; preserve T1/2/4. Dynamic-position replay remains uncertified. Native scratch build34064917232 hit compile timeout before device tests; bounded cold-build retry34066556771. Actual request target not achieved |
| E5 drafting | Matched actual norm-batch run34055684657 exact at22.462/18.669 decode tok/s; setup-inclusive rates regressed. Native-tape48-policy lookup analysis completed; historical MTP groundwork | Faster verifier and materially better drafting required; no DFlash2/DSpark/EAGLE3 TT adapter certified; offline routing estimates are not hardware results |
