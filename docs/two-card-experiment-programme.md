...
| E4 fusion/pipeline | Grouped attention full-model34062230310 exact; T32 verification110.02->103.31ms at4K,127.56->109.92ms at16K with norm batching in both arms. Direct layout DMA micro34063065156 also exact and faster | Real-layer DMA gate next; preserve T1/2/4. Dynamic-position replay still requires certification. Native scratch over-allocation prototype enables exact T8 groups in TTsim, not T32; hardware runtime unchanged |
