...
| E4 fusion/pipeline | Parallel attention full-model34067681095 exact: matched T32 verification99.33->95.88ms at4K,105.97->102.06ms at16K. Dynamic mask hardware34068177963 and changed-query/position reader34069798251 pass | Full-model retained attention replay gate next; preserve native T1/2/4 and reject cross-family tickets. Scratch cold rebuild loses existing graft symbols because CMake omits their sources; repair ABI separately. Actual committed request target remains unachieved |
