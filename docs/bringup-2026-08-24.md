...
> Historical bring-up guide, archived on 2026-09-08. Results, dependency status
> and launch settings below describe the earlier setup, not current recommendations.
> See the [current README](../README.md) for current measured results.
