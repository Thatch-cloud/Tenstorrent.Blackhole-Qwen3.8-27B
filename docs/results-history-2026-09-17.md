# Experiment results archive — 17 September 2026

Historical snapshots below retain their original dates, pending items and comparisons. Use the [current README](../README.md) for current status; do not combine these different recipes into one scaling curve.
...
**Building the next model?** Start with the [Blackhole tuning playbook](blackhole-tuning-playbook.md)
and [experiment record template](tuning-experiment-template.md).
...
reducing build setup from 263 to 3 seconds. [Seven-context ladder and evidence](combined-context-ladder.md).
...
included. [Combined result](frozen-draft-tail.md).
...
[Rejected trial](frozen-mlp-input-prefetch.md).
...
close that gap. [Draft-tail experiment](frozen-draft-tail.md) and
[profiling evidence and limits](pinned-kernel-profiling-inventory.md).
...
replay of the original winners. [Pinned recipe](winning-runtime-controls.md).
...
[Evidence and next diagnostic](matched-context-ladder.md).
...
speedup claim. [MLP results and attribution](64k-mlp-reintegration-results.md).
...
[Publication measurements and gates](64k-publication-attribution.md).
...
[Loader evidence](loading-diagnostic-results.md).
...
Run **34729556803** now measures the combined T16 verifier, shared Q/K
...
[8K evidence and remaining gates](draft-8k-numerical-investigation.md).
...
[Shared Q/K evidence](shared-qk-recurrence-results.md).
...
[Experiment and acceptance gates](gdn-copy-pairs-experiment.md).
...
[Fusion results](gdn-outer-add-experiment.md).
...
[Device attribution](combined-trace-attribution.md).
...
batch result is claimed. [Details and hashes](two-card-experiment-programme.md).
...
is established. [Run evidence and limitations](captured-gate-up-2026-09-11.md).
...
[Complete results, revisions and regressions](coding-screen-2026-09-10.md).
...
[Score-layout evidence](dspark-score-layout-2026-09-11.md#first-complete-hardware-result).
...
[Matched results](dspark-native-attention-results-2026-09-10.md).
...
[Latest comparison and timings](dspark-allocation-order-results-2026-09-10.md).
[Baseline run](https://github.com/Thatch-cloud/Tenstorrent.Blackhole-Qwen3.8-27B/actions/runs/34428179694)
and [capture failure diagnosis](dspark-capture-failure-2026-09-10.md).
...
[Details](dram-projection-reload-2026-09-10.md).
...
[Attention results](target-t16-attention-2026-09-10.md).
...
No promotion. [Combined result](dspark-combined-result-2026-09-10.md).
[Experiment details](gdn-norm-scatter-experiment-2026-09-10.md).
...
[Coding screen](coding-screen-2026-09-10.md).
...
- **Repeat-confirmed 4K result: PP 3,324.52 / CTX 4,096 / TG 74.27**, versus
  ...
  [Results](drafter-numerics-experiment-2026-09-09.md).
...
- **Attention result:** live-query attention is 7-10% faster in isolation, but
  ...
  correctness; all stalls remain included. No promotion. [Details](live-query-attention-2026-09-09.md).
- **Spare-core streaming result:** exact simulation and real-weight hardware
  ...
  guarantee lower latency. [Results](tensix-pooled-mlp-2026-09-09.md).
  [Device attribution](tensix-mlp-device-profile-2026-09-09.md) locates the
  slowdown in gate/up/down, not the copy or collective.
  [Sixteen producers](tensix-sixteen-producers-2026-09-09.md) improve the
...
- **Fixed-packet reader result:** simulator and hardware correctness pass, but
  ...
  [Results](weight-read-packets-2026-09-10.md).
- **Fabric result:** at CTX 4,096, four target-model links reach **61.41 TG versus
  ...
  are unchanged. [PP / CTX / TG table](target-model-link-counts-2026-09-09.md).

Smaller MLP tiles are [rejected: 4.70% slower](tiny-tile-projections-2026-09-09.md).
...
[Approximate draft attention](drafter-numerics-experiment-2026-09-09.md)
...
[4K hardware result](dflash-long-context-2026-09-09.md).
...
[8K result and timing spread](dflash-8k-context-2026-09-09.md).
[Matrix, measurement rules and next gates](pp-ctx-tg-benchmark-matrix.md).
...
[Real-target proposal integration now passes](dspark-target-integration-2026-09-10.md),
...
verifier is batched and captured. [Scope and correctness gates](dspark-full-history-2026-09-10.md).
...
[Baseline details and evidence](baseline-2026-09-05.md).
...
- [Experiment programme](two-card-experiment-programme.md): gates, failures and dated results.
- [August 24 bring-up guide](bringup-2026-08-24.md): historical build/launch instructions and longer-context results, including 256K. Not a current baseline.
- [Gotchas](gotchas.md): configuration and runtime constraints.
