...
passes in34332550656: gate/up/down account for most of the loss, not the copy or
collective. It uses unchanged qualified kernels and cannot qualify instrumented
timing for promotion. The next isolated hypothesis is producer issue capacity.
