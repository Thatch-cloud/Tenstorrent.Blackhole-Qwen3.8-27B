...
// [QWEN-SDPA-K0] k0c: K0 probe reader, NOT for serving (sdpa-prefill-share-spec.md 7.1).
...
// every core reads every K/V chunk (served), with a K/V read barrier every 32 tiles instead
...
void kernel_main() {
    ...
    constexpr uint32_t qwen_k0_kv_bt = 32;
