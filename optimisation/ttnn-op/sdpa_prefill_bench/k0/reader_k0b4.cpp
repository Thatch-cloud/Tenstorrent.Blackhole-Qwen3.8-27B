...
// [QWEN-SDPA-K0] k0b4: K0 probe reader, NOT for serving (sdpa-prefill-share-spec.md 7.1).
...
// as k0a, but the 16 would-be G6 injectors, (core_id / 8) % 6 == 0, read every K/V chunk
