...
// [QWEN-SDPA-K0] k0a: K0 probe reader, NOT for serving (sdpa-prefill-share-spec.md 7.1).
...
// K/V read from DRAM only for k_chunk 0 and 1; later chunks reserve and push the stale
