...
[[ "$PROBE" = dspark-native-fixed-attention-probe || "$PROBE" = dspark-wide-layout-probe || "$PROBE" = dspark-history-bank-probe || "$PROBE" = dspark-fixed-attention-probe || "$PROBE" = dspark-markov-sfpu-probe ]] ||
[[ "$PROBE" = dspark-layer-probe || "$PROBE" = dspark-residual-probe || "$PROBE" = dspark-attention-captured-probe || "$PROBE" = dspark-mesh-probe || "$PROBE" = dspark-layer-mesh-probe || "$PROBE" = dspark-backbone-mesh-probe || "$PROBE" = dspark-vocabulary-probe || "$PROBE" = dspark-noise-probe || "$PROBE" = dspark-full-attention-probe ]] ||
