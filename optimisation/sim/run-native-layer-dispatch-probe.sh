...
case "$PROBE" in
    dspark-native-cached-layer-probe|gdn-norm-scatter-probe|target-t16-attention-probe|dspark-approx-fixed-attention-probe|dram-sharded-projection-probe|dram-mlp-probe|dram-mlp-sharded-probe|dram-mlp-down-probe) ;;
    *) exit 64 ;;
esac
{
