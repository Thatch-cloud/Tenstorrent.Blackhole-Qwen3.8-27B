...
class GreedySession:
    def __init__(self, request_id, prompt, seed, *, vocab_size, max_new_tokens, eos_ids=(), neural=None, verifier_rows=16,
                 prefer_full_suffix=False, lookup_enabled=True):
        ...
        self.drafter = HybridDraft(request_id, prompt, vocab_size=vocab_size, neural=neural, lookup_enabled=lookup_enabled,
