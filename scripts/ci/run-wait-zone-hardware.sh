...
fixture=/home/thatch/.cache/qwen-experiments/dflash2-mlp-dedf8df68adfb1afeaf7b7480c0a0243108177b4
test -d "$fixture"
...
container=$(timeout -k 5 30 docker create --network none --hostname qwen-experiment --add-host qwen-experiment:127.0.0.1 \
    ...
    --mount "type=bind,src=$fixture,dst=/fixture-mlp,readonly" \
    ...
    --entrypoint /bin/bash "$image" /experiment-scripts/ci/wait-zone-hardware-suite.sh)
