...
python3 /experiment-scripts/ci/mlp_clock_hardware.py verify --directory /experiment-scripts/ci
status=0
...
test "$status" = 0
python3 /experiment-scripts/ci/mlp_clock_hardware.py validate --directory /experiment-scripts/ci \
