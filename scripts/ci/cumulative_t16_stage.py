...
from cumulative_t16_experiment import COMPACT_FILES
...
def stage(checkout, evidence, manifest):
    ...
    for name in COMPACT_FILES + ('cumulative_t16_experiment.py', 'cumulative_t16_scope.py'):
    ...
    result = dict(compact_admission=admission,
        ...
        components=['direct_windows', 'compact_scores'], hardware_qualified=False, performance_qualified=False)
