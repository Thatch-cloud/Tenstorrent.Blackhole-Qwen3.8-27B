...
from dspark_splitk_tree_denominator import transform as tree_denominator
...
def main():
    ...
    report.update(candidate='native-decode-fp32-tree-denominator-chunk256', performance_qualified=False,
        ...
        diagnostic_override=dict(key_chunk_size=256, max_cores_per_head=8, stripe_keys=False,
            ...
            purpose='256-key chunk compile and tree gate; 512-key fixture does not exercise long local recurrence'))
