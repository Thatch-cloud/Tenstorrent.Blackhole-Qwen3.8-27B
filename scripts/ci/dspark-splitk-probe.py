...
def main():
    ...
    with patch.object(correction, 'transform', lambda source: correction_rounding(recurrence_transform(original_transform(source)))), \
    ...
    report.update(candidate='native-decode-correction-factor-rounding', performance_qualified=False,
