...
from gdn_input_overlap_gate import KERNEL, validate_report


def fixture():
    report = dict(passed=True, closed_cleanly=True, norm_unchanged=True,
        state_math_unchanged=True, shared_qk_preparation=True, input_overlap=True,
...
class InputOverlapGateTests(unittest.TestCase):
