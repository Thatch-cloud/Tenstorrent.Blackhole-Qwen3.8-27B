"""Approximate-exp native proposal SDPA at fixed 4384 capacity and fifteen queries; simulator only, no TG qualification."""
...
SOURCES = tuple(sorted(set(FULL.SOURCES + ('dspark-approx-fixed-attention-probe.py', 'dspark_fixed_inputs.py', 'dspark_cached_layer.py',
    'dspark_approx_native_attention.py', 'draft_attention.py', 'native_draft_sdpa.py', 'dspark-attention-probe.py'))))
