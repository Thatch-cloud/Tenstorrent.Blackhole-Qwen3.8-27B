...
from gdn_output_l1_variants import POLICIES, validate_route
...
class OutputVariantsTests(unittest.TestCase):
    ...
    def test_each_layer_and_restoration_required(self, publication):
        ...
        for defect in ('hit', 'restored', 'hash'):
            ...
            if defect == 'hit':
                changed['gdn_output_l1']['hits'][47] = 0
            elif defect == 'restored':
                changed['gdn_output_l1']['restored'] = False
            else:
                changed['gdn_output_l1']['admission']['report_sha256'] = 'different'
