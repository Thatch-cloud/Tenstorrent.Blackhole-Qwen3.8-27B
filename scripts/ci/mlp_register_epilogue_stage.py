...
def stage(checkout, manifest, *, diagnose_activation=False):
    if manifest.exists():
    ...
    payloads = {'fused_1d.py': adapt_projection(originals['fused_1d.py'], diagnose_activation=diagnose_activation),
...
def main():
    ...
    parser.add_argument('--diagnose-activation', action='store_true')
