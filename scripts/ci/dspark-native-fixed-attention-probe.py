"""Precise native SDPA at fixed 4384 capacity and fifteen queries; simulator only, no TG qualification."""
...
SOURCES = tuple(sorted(set(FULL.SOURCES + ('dspark-native-fixed-attention-probe.py', 'dspark_fixed_inputs.py', 'dspark_cached_layer.py',
