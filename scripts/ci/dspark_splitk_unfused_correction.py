...
'''
    ...
    return transform_precise_exp(transform_final_input(transform_sum_input(transform_copies(transform_mask(result.replace(reciprocal, snapshot + precise).replace(include,
