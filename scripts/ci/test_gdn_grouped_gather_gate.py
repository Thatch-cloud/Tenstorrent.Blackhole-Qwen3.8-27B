...
from gdn_grouped_gather_gate import KERNEL, validate_report


def fixture():
    report = dict(passed=True, closed_cleanly=True, norm_unchanged=True,
        state_math_unchanged=True, shared_qk_preparation=True, grouped_gather=True,
...
class GroupedGatherGateTests(unittest.TestCase):
