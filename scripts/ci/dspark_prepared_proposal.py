...
from dspark_fixed_inputs import proposal_inputs
...
from dspark_wide_target import noise_embeddings, pack_tokens, shared_head_logits
...
class PreparedDSparkProposal:
    def __init__(self, device, anchor, *, audit=False):
        ...
        try:
            host = proposal_inputs(anchor, device.position, device.history.capacity, device.max_drafts, device.rotary)
